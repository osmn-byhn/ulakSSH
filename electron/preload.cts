...
contextBridge.exposeInMainWorld("api", {
  ...
  getServerApps: (serverId: string) => ipcRenderer.invoke('get-server-apps', serverId),
  checkServerAppUpdates: (serverId: string) => ipcRenderer.invoke('check-server-app-updates', serverId),
  updateServerApp: (serverId: string, name: string, type: string) => ipcRenderer.invoke('update-server-app', serverId, name, type),
