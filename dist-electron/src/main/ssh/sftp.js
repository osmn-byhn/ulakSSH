import { getSftp, executeCommand } from './execute.js';
export const readRemoteFile = async (session, remotePath) => {
...
export const writeRemoteFile = async (session, remotePath, content) => {
    const sftp = await getSftp(session);
    return new Promise((resolve, reject) => {
...
export const createRemoteDirectory = async (session, path) => {
    const sftp = await getSftp(session);
    return new Promise((resolve, reject) => {
...
export const deleteRemoteItem = async (session, path, isDirectory) => {
...
export const renameRemoteItem = async (session, oldPath, newPath) => {
    const sftp = await getSftp(session);
    return new Promise((resolve, reject) => {
...
export const uploadLocalFile = async (session, localPath, remotePath, onProgress) => {
    const sftp = await getSftp(session);
    return new Promise((resolve, reject) => {
...
export const archiveAndDownloadDirectory = async (session, remotePath, localPath, onProgress) => {
